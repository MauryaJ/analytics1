...
# when the answer required is in binary means in Yes or No form

#https://stats.idre.ucla.edu/r/dae/logit-regression/

#A researcher is interested in how variables, 
#such as GRE (Graduate Record Exam scores), 
#GPA (grade point average) and prestige of the 
#undergraduate institution, effect admission into 
#graduate school. The response variable, admit/don’t admit,
...
sapply(inputData, sd)
#above gives the standard deviation for all four columns
lapply(inputData, sd)
...
addmargins(t1)
# adding sum raw and column wise
